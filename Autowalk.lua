return function(WindUI, AutoWalkTab)
    ...
    -- ==========================================
    -- UI ELEMENTS (WIND UI) - ANTI CRASH
    -- ==========================================
    ...
    -- Slider Sederhana (Tanpa parameter default/step yang bikin crash)
    AutoWalkTab:Slider({
        ...
        Callback = function(value)
            ...
            if isPlaying and not isAutoWalkingToStart and StatusPara then
                pcall(function() StatusPara:SetDesc(string.format("Status: Berjalan (%dx Speed)", playSpeed)) end)
            end
        end
    })
    ...
    PlayBtn = AutoWalkTab:Button({
        ...
        Callback = function()
            ...
            -- Cari frame terdekat untuk dituju
            ...
            playConn = RunService.Stepped:Connect(function()
                ...
                if isAutoWalkingToStart then
                    ...
                    if dist > 3 then
                        ...
                        WindUI:Notify({Title="Menempel", Content="Memulai rute!", Duration=1.5})
                        if StatusPara then pcall(function() StatusPara:SetDesc(string.format("Status: Berjalan (%dx Speed)", playSpeed)) end) end
                    end
                else
                    -- FASE 2: PLAYBACK RUTE (BISA SENTUH CP)
                    hrp.Anchored = false -- PENTING! Harus false agar karakter bisa menyentuh Checkpoint
                    ...
                    if currentData then
                        ...
                        -- Kalkulasi arah pergerakan agar Animasi Roblox terpicu
                        ...
                        -- Loncati frame sesuai kecepatan
